...
const Footer = () => {
    if (document.documentElement.scrollHeight > window.innerHeight) {
        return (
            <div class="bg-FooterColor w-full h-48 flex relative">
                <div class="pt-8 pl-8">
        ...
        console.log("Page height fits within the screen height.");
        return (
            <div class="bg-TagsBackground w-full h-48 flex  absolute bottom-0">
                <div class="pt-8 pl-8">
                    <div class="flex items-center">
                        <svg width="26" height="34" viewBox="0 0 26 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M14.8 25.4384L2 31V2H14.8M14.8 25.4384L24 31V2H14.8M14.8 25.4384V2" stroke="#352F2C" stroke-width="3" />
